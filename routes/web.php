...
Route::post('/wishlist/move-to-card/{rowId}', [WishlistController::class, 'move_to_cart'])->name('wishlist.move.to.cart');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/account-detail', [UserController::class, 'account_detail'])->name('user.account_detail');
    Route::post('/account-detail/update', [UserController::class, 'update_account_details'])->name('user.account_detail.update');
